 ...
 * @author ΠΑΝΟΣ
 */
public class ResFind extends javax.swing.JFrame {

    /**
     * Creates new form ResFind
     */
    public ResFind() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        textField1.setText("Enter Reservation's ID");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResFind.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
